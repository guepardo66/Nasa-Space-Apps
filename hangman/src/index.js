...
//word array
const question = [
  "The Chosen Category Is Space",
  "The Chosen Category Is EMIT",
  "The Chosen Category Is Nasa"
];
...
const categories = [
  ...
  ["emit", "nasa", "mineral", "dust", "sensor"],
  ["United-States", "Space-Agency", "astronaut", "space-ship", "satellite"]
];
  ...
  if (answer === winningCheck) {
    ...
    if (life > 0) {
      ...
      if (life > 1) {
        ...
        body.innerHTML = "";
        body.innerHTML = `<p style="margin-bottom: 40px;">
        araba ${chosenWord}
      </p>`;
      }
    } else {
